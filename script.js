...
function checkDateTime(year, month, day, hour, minute) {
  ...
  if (selectedDateTime < now) {
    alert('The selected date and time cannot be earlier than now!');
    return false;
  }
  return true;
}
...
nextbutton.addEventListener('click', (e) => {
  ...
  if (currentStep === 1) {
    ...
    // Step 1 → Step 2 transition animation
    ...
    document.getElementById('f-next').textContent = 'Calculate';
    ...
    document.getElementById('f-next').textContent = 'Finish';
    currentStep = 3;
